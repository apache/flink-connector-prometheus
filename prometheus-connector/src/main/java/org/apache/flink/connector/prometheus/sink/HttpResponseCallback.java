 ...
 * SinkWriterErrorHandlingBehaviorConfiguration}. Depending on the condition, the sink may throw an
 * exception and cause the job to fail, or log the condition to WARN, increment the counters and
